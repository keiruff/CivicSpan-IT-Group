      ...
      <section className="px-6 py-16 max-w-7xl mx-auto border-t border-white/5">
        <div className="rounded-2xl border border-green-500/20 bg-[radial-gradient(circle_at_top_right,rgba(34,197,94,0.12),transparent_52%),rgba(15,23,42,0.8)] p-7 sm:p-10 flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
          <div className="max-w-2xl">
            <p className="text-primary font-bold text-xs tracking-wider uppercase mb-2">Early Career</p>
            <h2 className="text-2xl sm:text-3xl font-extrabold text-white mb-3">Spring 2027 Technology Internship Program</h2>
            <p className="text-neutral-light text-sm sm:text-base leading-relaxed">CivicSpan is building its Spring 2027 internship cohort for students interested in technology, cloud, cybersecurity, software, analytics, business operations, and government technology.</p>
          </div>
          <Link href="/internships" className="inline-flex shrink-0 items-center justify-center px-6 py-3 bg-primary hover:bg-primary-dark text-dark font-bold rounded-lg transition-all duration-300 hover:-translate-y-0.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-dark">Explore Internships <span aria-hidden="true" className="ml-1">→</span></Link>
        </div>
      </section>
